...
export class AbiEncoder {
    registerWithServer(server: any) {
        server.registerTool("abi-encode", {
            title: "abi encode",
        ...
        }, async ({ types, values }: {types: any, values: any}) => {
            try {
        ...
        server.registerTool("abi-encode-with-signature", {
        ...
        }, async ({ functionSignature, values }: {functionSignature: string, values: any}) => {
            try {
        ...
        server.registerTool("abi-decode", {
            title: "abi decode",
        ...
        }, async ({ types, data }:  {types: any, data: any}) => {
            try {
    ...
    processValues(types: any, values: any) {
    ...
    formatDecodedValue(value: any, type: any) {
